...
<p align="center">
  <img src="docs/multigent.png" alt="Multigent Web 控制台" width="860">
</p>
...
Multigent 默认 runtime 镜像发布在 `ghcr.io/multigent/multigent/runtime-base:latest`。`multigent` 和 `mga` 会一起安装，Docker sandbox 可以自动挂载 Agent 专用的 runtime CLI。
...
配置支持 CLI 参数、环境变量和 TOML 配置文件。详见 [配置与日志](docs/configuration-and-logging.md)。
