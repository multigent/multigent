...
- 保留扁平 Team 字段，新增 Project owner/context 字段；项目内需求分流统一收敛到 Task、Task Relation、label、milestone 和 assignee。
...
- Context Pack 管理和版本化。
- Task graph、任务状态机、review queue 和 release/milestone 视图。
- Agent Role 配置和评估。
