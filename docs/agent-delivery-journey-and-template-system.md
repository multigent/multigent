...
- Project Playbook Template 应该学习 MetaGPT：流程要靠 SOP 和结构化产物，而不是靠 agent 自由发挥。
...
- 用 Project Playbook Template 帮企业把流程变成 agent 可执行上下文。
...
- 定义 Project Playbook Template 数据结构。
