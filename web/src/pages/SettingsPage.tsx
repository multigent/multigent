...
const GATEWAY_ACCOUNT_PRESETS: ProviderPreset[] = [
  ...
  { id: 'minimax-codex', label: 'MiniMax 国际区', cli: 'codex', baseUrl: 'https://api.minimax.io/v1', model: 'MiniMax-M3', models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'], hint: 'OpenAI-compatible API' },
  { id: 'minimax-cn-codex', label: 'MiniMax 中国区', cli: 'codex', baseUrl: 'https://api.minimaxi.com/v1', model: 'MiniMax-M3', models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'], hint: 'OpenAI-compatible API (China)' },
  { id: 'minimax-claude', label: 'MiniMax 国际区', cli: 'claudecode', baseUrl: 'https://api.minimax.io/anthropic', model: 'MiniMax-M3', models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'], hint: 'Anthropic-compatible API' },
  { id: 'minimax-cn-claude', label: 'MiniMax 中国区', cli: 'claudecode', baseUrl: 'https://api.minimaxi.com/anthropic', model: 'MiniMax-M3', models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'], hint: 'Anthropic-compatible API (China)' },
